...
def _( shed, word_list , n_best=3  ):
    ...
    for i in range(n):
        ...
        best_n_word_pair_shed.append(temp)
    ...
    Words = slot_class.Struct('words', 'shed', 'levs', 'conv', 'shed_args', 'levs_args', 'conv_args', 'shed_metaphs', 'lev_metaphs', 'conv_metaphs')
