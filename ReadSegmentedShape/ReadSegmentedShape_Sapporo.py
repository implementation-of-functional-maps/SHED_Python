...
def _(off_file, seg_file):
    ...
    import ReadSegmentedShape.mesh_read_off as mesh_read_off
    ...
    # Get faces that belong to that segment:
        ...
        seg_faces = M1_faces[list(np.where(seg_arr  == i+1))] 
        Segment_i.Vertices = []
        Segment_i.Faces = []
        ...
        if len(seg_faces) > 3:
            ...
            Segment_i.Vertices = M1.vertices[seg_ver_i]
